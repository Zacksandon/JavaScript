...
window.addEventListener('load', () => {
    ...
    // Interactividad para registro de eventos
    document.querySelectorAll('.btn-registrarse-evento').forEach(button => {
        button.addEventListener('click', () => {
            alert(`Te has registrado para ${button.parentElement.querySelector('h3').textContent}. ¡Revisa tu correo!`);
        });
    });
